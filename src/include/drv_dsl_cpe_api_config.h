...
#define INCLUDE_DSL_ATM_PTM_INTERFACE_SUPPORT 1
...
#define PACKAGE_STRING "DSL CPE API driver 4.15.2-pd1"
...
#define PACKAGE_VERSION "4.15.2-pd1"

/* Version number of package */
#define VERSION "4.15.2-pd1"
